    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 py-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          <button onClick={handleSignIn} className='bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 flex items-center justify-center mt-6'>Sign Out</button>
          ...
          {rooms && rooms.map((room, index) => (
            <div key={room.id} className="bg-white rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-6">
                ...
                <button onClick={() => { bookNowRoom(room.id) }} className="mt-4 w-full bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700">
                  Book Now
                </button>
              </div>
            </div>
